...
signature of this function should be:
  ...
  An example set of parameters are specifed as:
    'parameters' : {
      ...
      'maxiter'   : {'order':3, 'enable':False,'type':int,  'value':4000,  'range':range(sys.maxsize)},
      'maxfun'    : {'order':4, 'enable':False,'type':int,  'value':4000,  'range':range(sys.maxsize)},
...
algorithms = {
  ...
  'BFGS'                : {
    ...
    'parameters' : {
      ...
      'maxiter'   : {'order':5,'enable':False,'type':int,  'value':4000,  'range':range(sys.maxsize)},
  ...
  'L-BFGS-B'            : {
    ...
    'parameters' : {
      ...
      'm'           : {'order':4, 'enable':True, 'type':int,  'value':10,    'range':range(sys.maxsize)},
      ...
      'iprint'      : {'order':8, 'enable':True, 'type':int,  'value':-1,    'range':range(-1,sys.maxsize-1)},
      'maxfun'      : {'order':9, 'enable':False,'type':int,  'value':15000, 'range':range(sys.maxsize)},
...
if hasattr(opt,'anneal'):
  ...
  algorithms['Simulated Annealing'] = {
    ...
    'parameters' : {
      ...
      'maxeval'   : {'order':4, 'enable':False,'type':int,  'value':4000,  'range':[0,sys.maxsize,10,100],'combo':False},
      'maxaccept' : {'order':5, 'enable':False,'type':int,  'value':4000,  'range':[0,sys.maxsize,10,100],'combo':False},
      'maxiter'   : {'order':6, 'enable':True, 'type':int,  'value':400,   'range':[0,sys.maxsize,10,100],'combo':False},
      ...
      'dwell'     : {'order':15,'enable':True, 'type':int,  'value':50,    'range':[0,sys.maxsize,1,10],  'combo':False},
    },
  }
